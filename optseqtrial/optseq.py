...
__all__ = ['plot_optseq', 'Parameters', 'Mode', 'Activity', 'Resource', 'Temporal', 'State', 'Model', 'make_gannt',
           'make_resource_graph', 'ex1', 'ex2', 'ex3', 'ex4', 'ex5', 'ex6', 'ex7', 'ex8', 'ex9', 'ex10', 'ex11', 'ex12',
           'ex13', 'ex14', 'ex15', 'ex16']
...
class Mode():
    ...
    def addResource(self, resource, requirement=None, rtype=None):
        ...
        if type(resource.name) != type("") or type(requirement) != type({}):
            ...
            raise TypeError("type error in adding a resource {0} to activity".format(resource.name, self.name))
